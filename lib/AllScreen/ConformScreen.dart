...
class ConformScreen extends StatefulWidget {const ConformScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
        stream:
        FirebaseFirestore.instance.collection('trackingOrder').where(
            'deliver', isEqualTo: true)
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      var newViewDetailValue = !order['deliveryViewDetail'];
